...
const TITLE = "سرویس احراز هویت ویدیویی";
...
function VideoKyc() {
  ...
  return (
    <section className="service-item video-section" id="video">
      <h2>{TITLE}</h2>
      <p style={{ padding: "22px" }}>
        «سرویس احراز هویت ویدیویی» در قالب API و SDK ارائه می‌شود. کسب و کارها
        با استفاده از قابلیت‌های این سرویس می‌توانند هویت مشتریان حقیقی خود را
        احراز کنند. از کاربردهای دیگر این وب سرویس احراز هویت مدیران و احراز
        هویت ذینفعان در فرایند «احراز هویت اشخاص حقوقی» است.
      </p>
      <p style={{ padding: "22px" }}>
        کسب و کارهایی مانند فینتک‌ها، صرافی‌های ارز دیجیتال، بانک‌ها، بیمه‌ها،
        اپراتورهای تلفن همراه و پلتفرم‌های خرید و فروش که نیاز جدی به احراز هویت
        مشتریان خود دارند، می‌توانند از سرویس «احراز هویت ویدیویی» لوانت
        بهره‌برداری کنند.
      </p>
      ...
      <div className="items-container">
        <div className="item no-shadow request">
          ...
          <ul>
            ...
            <li>
              <span className="description">دریافت فیلم کاربر</span>
            </li>
          </ul>
        </div>
        <div className="item no-shadow process">
          ...
          <ul>
            <li>
              <span className="description">بررسی Liveness ویدیو</span>
            </li>
            <li>
              <span className="description">
            ...
            <div className="col-item">
              <div className="image-container">
                ...
                <div className={"message " + (secondUploaded ? "success" : "")}>
                  {!secondUploaded && <span>ویدیو سلفی را بارگذاری کنید</span>}
                  {secondUploaded && <span>ویدیو سلفی بارگذاری شد</span>}
                </div>
              </div>
